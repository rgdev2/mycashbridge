...
(function () {
  ...
  */
  ...
  var HI = {
    ...
    "Personal Loan rates from HDFC Bank": "HDFC Bank के पर्सनल लोन रेट",
    ...
    "HDFC Bank Credit Cards,": "HDFC Bank क्रेडिट कार्ड,",
    "Browse HDFC Bank Credit Cards": "HDFC Bank क्रेडिट कार्ड ब्राउज़ करें",
    ...
    "Education Loan rates from HDFC Bank": "HDFC Bank से एजुकेशन लोन रेट",
    ...
    "Ready to apply for an HDFC Bank Credit Card?": "HDFC Bank क्रेडिट कार्ड के लिए अप्लाई करने को तैयार?",
    ...
    "Car Loan rates from HDFC Bank": "HDFC Bank से कार लोन की दरें",
    ...
    "Gold Loan rates from HDFC Bank": "HDFC Bank से गोल्ड लोन की दरें",
    ...
    "Home Loan rates from HDFC Bank": "HDFC Bank से होम लोन की दरें",
    ...
    "Loan Against Property rates from HDFC Bank": "HDFC Bank से लोन अगेंस्ट प्रॉपर्टी की दरें",
    ...
    "We are an authorised partner for HDFC Bank. Apply for any HDFC credit card through us — same official cards, same benefits, with a dedicated advisor to guide you every step of the way.": "हम HDFC Bank के अधिकृत पार्टनर हैं। हमारे ज़रिए किसी भी HDFC क्रेडिट कार्ड के लिए अप्लाई करें — वही ऑफिशियल कार्ड, वही बेनिफिट्स, और हर कदम पर गाइड करने के लिए एक डेडिकेटेड एडवाइज़र।",
    ...
    "Business Loan rates from HDFC Bank": "HDFC Bank के बिज़नेस लोन रेट्स",
    ...
    "🏦 HDFC Bank — Authorised Partner": "🏦 HDFC Bank — अधिकृत पार्टनर",
